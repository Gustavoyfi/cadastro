        ...
        <div class="box form-box">
            ...
            require_once $_SERVER['DOCUMENT_ROOT'] . '/cadastro/HTML/php/config.php';
              if(isset($_POST['submit'])){
                ...
                $result = mysqli_query($conn, "SELECT * FROM administrador WHERE email='$email' AND senha='$senha'") or die("Erro na consulta");
            ...
            ?>
            <header>Acesse sua conta administrador</header>
