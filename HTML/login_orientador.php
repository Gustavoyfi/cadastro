        ...
        <?php 
             ...
             require_once $_SERVER['DOCUMENT_ROOT'] . '/cadastro/HTML/php/config.php';
               if(isset($_POST['submit'])){
                 ...
                 $result = mysqli_query($conn,"SELECT * FROM orientador WHERE email_orientador='$email' AND senha_orientador='$senha' ") or die("Select Error");
             ...
             ?>
            <header>Acesse sua conta orientador</header>
