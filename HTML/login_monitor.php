        ...
        <?php 
             ...
             require_once $_SERVER['DOCUMENT_ROOT'] . '/cadastro/HTML/php/config.php';
               if(isset($_POST['submit'])){
                 ...
                 $result = mysqli_query($conn,"SELECT * FROM monitor WHERE email_monitor='$email' AND senha_monitor='$senha' ") or die("Select Error");
             ...
             ?>
            <header>Acesse sua conta monitor</header>
